...
//// if num has - then red else green 
return (
<div className={`${dynamicPercentageCheck ? "text-teal-400": "text-red-500" } flex gap-1 items-center`}>
{dynamicPercentageCheck ? <TriangleUp className="text-teal-400 fill-current" width="20px" height="20px" /> : <TriangleDown  className="text-red-500 fill-current" width="20px" height="20px" /> }{symbolType == "currency" ? symbol : "" } {dynamicPercentage.toLocaleString()}{symbolType == "percentage" ? "%" : ""}   
</div>
);
}