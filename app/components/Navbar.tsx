...
function Navbar() {
  ...
  <div className="flex  px-7 py-4 justify-between items-center">
    ...
    <div className="flex items-center flex-wrap gap-4">
      <NavLogo className="md:w-11 md:h-11 w-6 h-6  mx-8 text-white" />
    ...
    <div className="flex  items-center  md:gap-6 gap-2 w-full">
      {/* Search Input */}
      <div className="dark:bg-slate-900 flex-1 p-2">
       he
      </div>

      {/* Currency List */}
      <div className="dark:bg-slate-900 bg-purple-100 flex-2  p-2 ">
        hw
      </div>

      {/* Theme Toggle */}
      <div className="dark:bg-slate-900 bg-purple-100 flex-1   p-2">
       he
      </div>
    </div>
  </div>
